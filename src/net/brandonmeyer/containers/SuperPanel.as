...
[Event(name="edit", type="net.brandonmeyer.events.SuperPanelEvent")]

[Event(name="save", type="net.brandonmeyer.events.SuperPanelEvent")]
 ...
 *  The style name for the minimize button.
 */
[Style(name="editButtonStyleName", type="String", inherit="no")]

[Style(name="superSaveButtonStyleName", type="String", inherit="no")]
/**
...
public class SuperPanel extends Panel
{
   ...
   protected var oldBorderSkinClass:Object = null   ;
   protected var oldAllowEdit:Boolean;
   protected var oldAllowMin:Boolean;
   protected var oldAllowMax:Boolean;
   protected var oldAllowClose:Boolean;
   protected var oldResize:Boolean;
   protected var oldTitle; 
   protected var oldAllowSave:Boolean;
    ...
    public function SuperPanel()
    {
        ...
        this.addEventListener(MouseEvent.ROLL_OVER, onPanelMouseOverHandler);
        this.addEventListener(MouseEvent.ROLL_OUT, onPanelMouseOutHandler);
    ...
    public function onPanelMouseOverHandler(event:MouseEvent):void{
    	
    	if(this._allowAutoHideTitleBar){
    		var obj:Object = this.getStyle("headerHeight");
    		
	    	if(this.getStyle("headerHeight")!=18){
	    		
	    		this.setStyle("borderSkin", this.oldBorderSkinClass);
	    		this.allowClose = this.oldAllowClose;
	    		this.allowEdit = this.oldAllowEdit;
	    		this.allowMaximize = this.oldAllowMax;
	    		this.allowMinimize = this.oldAllowMin;
	    		this.allowResize = this.oldResize;
	    		this.allowSave = this.oldAllowSave;
	    		this.title = this.oldTitle;
	    		this.setStyle("headerHeight","18");
	    		
	    		trace("set hide false");
	    	}
	    }
	   
    }
    
    public function onPanelMouseOutHandler(event:MouseEvent):void{
    	
    	if(this._allowAutoHideTitleBar){
    		this.setStyle("headerHeight","1");
    		if(oldBorderSkinClass==null){
    			oldBorderSkinClass = this.getStyle("borderSkin");
    			this.oldAllowEdit = this.allowEdit;
    			this.oldAllowClose = this.allowClose;
    			this.oldAllowMax = allowMaximize;
    			this.oldAllowMin = allowMinimize;
    			this.oldResize = allowResize;
    			this.oldTitle = title;
    			this.oldAllowSave = this.allowSave;
    		}
    		this.title = null;
    ...
    //allow edit
    private var _allowEdit:Boolean = false;
    [Bindable]
    ...
    public function get allowEdit():Boolean
    {
      ...
      //allow save //保存
    private var _allowSave:Boolean = false;
    [Bindable]
    ...
    private var _allowAutoHideTitleBar:Boolean = false;
    
    public function get allowAutoHideTitleBar():Boolean{
    	return this._allowAutoHideTitleBar;
    }
    public function set allowAutoHideTitleBar(v:Boolean):void{
    	this._allowAutoHideTitleBar = v;
    }
    ...
    //添加superSaveButton
    protected var superSaveButton:Button;
    // States
     ...
     *  @private
     */
    private var _editButtonStyleChanged:Boolean = true;
    private var _superSaveButtonStyleChanged:Boolean = true;
    /**
     *  @private
     */
    ...
    private function creationCompleteHandler(event:FlexEvent):void
    {
    	...
    	titleBar.addEventListener(MouseEvent.MOUSE_OUT, 
    							  titleBar_mouseOutHandler);
    	
    	titleBar.addEventListener(MouseEvent.MOUSE_OVER, 
    							  titleBar_mouseOverHandler);
     ...
     *  @private
     */
    protected function titleBar_mouseOverHandler(event:MouseEvent):void
    {
    	//debug1
    }
     ...
     *  @private
     */
    protected function titleBar_mouseOutHandler(event:MouseEvent):void
    {
     ...
     *  @private
     */
    public function titleBar_mouseUpHandler(event:*):void
    {
    	if (!allowDrag)
    		return;
     ...
     *  @private
     */
    protected function titleBar_mouseMoveHandler(event:MouseEvent):void
    {
    ...
    override protected function createChildren():void
    {
    	...
    	//添加
    	if(!superSaveButton){
    		superSaveButton = new Button();
    		superSaveButton.label = "保存";
    		superSaveButton.width = superSaveButton.height = 16;
    		superSaveButton.toggle = true;
    		buttonContainer.addChild(superSaveButton);
    	}
    ...
    override public function styleChanged(styleProp:String):void
    {
    	...
    	switch (styleProp)
    	{
    		...
    		case "editButtonStyleName":
    		{
    		    _editButtonStyleChanged = true;
    		    invalidateProperties();
    		    
    		    break;
    		}
    		case "superSaveButtonStyleName":
    		{
    		    _superSaveButtonStyleChanged = true;
    		    invalidateProperties();
    ...
    override protected function commitProperties():void
    {
    	...
    	if (editButton)
    	{
    		editButton.enabled = this.enabled;
    		editButton.visible = minimizeButton.includeInLayout = _allowEdit;
    		
    		
    		
    		if (_editButtonStyleChanged)
    		{
    		    editButton.styleName = this.getStyle("editButtonStyleName");
    		    _editButtonStyleChanged = false;
    		}
    	}
    	
    	if (superSaveButton)
    	{
    		superSaveButton.enabled = this.enabled;
    		superSaveButton.visible = minimizeButton.includeInLayout = _allowSave;
    		
    		
    		
    		if (_superSaveButtonStyleChanged)
    		{
    		    superSaveButton.styleName = this.getStyle("superSaveButtonStyleName");
    		    _superSaveButtonStyleChanged = false;
    		}
    	}
